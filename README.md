...
Astro + Tailwind CSS, deployed on Cloudflare Workers. Content is Markdown in
this repo; editing happens through GitHub.
...
(To be added once the Astro project is scaffolded.)
